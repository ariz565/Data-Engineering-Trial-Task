...
# Function to analyze HTML content using OpenAI API and extract relevant attributes
def analyze_with_openai(html_content):
    # Process the HTML content
    # For demonstration, let's assume we're analyzing the content for standard attributes using OpenAI API
    openai_predicted_attributes = {
    ...
    return openai_predicted_attributes

# Function to standardize data according to Table 2
def standardize_data(title, description, additional_info, openai_predicted_label, url):
    ...
    # Analyze description with OpenAI API
    openai_predicted_label = openai_predicted_label or analyze_with_openai(description)
    ...
    standardized_data = {
        ...
        "sector": sector,
        "subsector": subsector,
        "openai_predicted_label": openai_predicted_label
    }
